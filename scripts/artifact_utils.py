...
SCHEMAS = {
    ...
    "investigation-report": {
        # Identity of the Investigation epic this report covers.
        "epic_id": {
            "type": "string",
            "required": True,
        },
        ...
        # Lifecycle state of the investigation RUN — lets CI know if it
        # finished. Distinct from `recommendation`, which is the verdict
        # for the gated sibling epics.
        "status": {
            "type": "string",
            "required": True,
            "enum": ["in_progress", "complete", "blocked", "error"],
        },
        # Verdict on whether the epics this investigation gates may proceed.
        # Null until the run completes.
        "recommendation": {
            "type": "string",
            "required": False,
            "enum": ["go", "go-with-changes", "no-go"],
            "default": None,
        },
        "questions_total": {
            "type": "int",
        ...
        # Questions punted to Tier 2 (needs a container runtime or a live
        # cluster, so not executable in the investigation sandbox).
        "questions_deferred": {
            "type": "int",
            "required": False,
            "default": 0,
        ...
        # True when any question was deferred for needing a cluster or a
        # container runtime the sandbox lacked.
        "deferred_to_cluster": {
            "type": "bool",
            "required": False,
            "default": False,
        },
        # Sibling epic IDs whose go/no-go this investigation determines.
        "gated_epics": {
            "type": "list",
            "required": False,
            "default": [],
        },
        # Per-question rollup (full evidence lives in the markdown body).
        # Each item: {question, tier, answer, confidence}.
        "findings": {
            "type": "list",
            "required": False,
            "default": [],
